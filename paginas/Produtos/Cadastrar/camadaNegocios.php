...
$tb = 'Produto';
$send=filter_input(INPUT_POST,'cadastrarProdutoSubmit',FILTER_SANITIZE_STRING);
if($send){
	...
	$result_msg_cont = "SELECT count(*) 'quantidade' FROM $db.$tb Where nomeProduto=:nome";
    ...
    $result_msg_cont = "INSERT INTO $db.$tb (nomeProduto,valorProduto) VALUES (:nome,:valor)";
	...
	$insert_msg_cont->bindParam(':valor',$valor);
