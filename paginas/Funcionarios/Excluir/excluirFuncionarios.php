...
<body>
    <div class="divCadastros">
		...
		<?php
				...
				echo "<p class='text-danger'>".$_SESSION['excluirFuncionarioFalha']."</p>";
				unset($_SESSION['excluirFuncionarioFalha']);}
		?>
        ...
        <form id="formCadastros" method="POST" action="camadaNegocios.php">
            <label for="codigoFuncionarioExcluir">Código:</label> <input class="form-control" id="codigoFuncionarioExcluir" name="codigo" type="number" placeholder="Código da funcionário" min="0" max="99999999999" required />
            <input name="excluirFuncionarioSubmit" class="inputSubmit btn btn-large col-sm-15 btn-funcionarios" type="submit" value="Excluir" onClick="return confirmarSubmit()"/>
        </form>
    </div>
	<script>
